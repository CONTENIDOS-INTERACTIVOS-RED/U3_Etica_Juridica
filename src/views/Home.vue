        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde una perspectiva ética y jurídica, la profesión de abogado exige no solo conocimientos técnicos, sino un compromiso integral con la justicia, la dignidad humana y el Estado de Derecho. En esta tercera unidad, se explorará el marco normativo que regula la conducta profesional de los abogados en Colombia, mediante el estudio del código disciplinario del abogado y el Código General Disciplinario. Se analizarán las faltas, las modalidades de conducta sancionable, las causales de exclusión y la acción disciplinaria, comprendiendo cómo estos elementos consolidan la ética como eje central del ejercicio jurídico.
              
              p #[b ¡Prepárese para conocer el poder transformador de la ética en la abogacía profesional!]
...
.iniciar-btn-container
  ...
  .icon
    ...
    background-color: #4A5641 !important
  &:hover
    .icon
